...
// cmd-basic***
//usr grp cmd
else if(inputText.toLowerCase().indexOf("passwd")>-1||inputText.toLowerCase().indexOf("usr pw")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chage")>-1||inputText.toLowerCase().indexOf("pw settings")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("w")>-1||inputText.toLowerCase().indexOf("curr usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("who")>-1||inputText.toLowerCase().indexOf("sys usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("useradd")>-1||inputText.toLowerCase().indexOf("add usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("usermod")>-1||inputText.toLowerCase().indexOf("modify usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("userdel")>-1||inputText.toLowerCase().indexOf("delete usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("id")>-1||inputText.toLowerCase().indexOf("acct info")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("groupadd")>-1||inputText.toLowerCase().indexOf("create grp")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("groupmod")>-1||inputText.toLowerCase().indexOf("modify grp")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("groupdel")>-1||inputText.toLowerCase().indexOf("remove grp")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("su")>-1||inputText.toLowerCase().indexOf("switch usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("sudo")>-1||inputText.toLowerCase().indexOf("delegate privileges")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("pkexec")>-1||inputText.toLowerCase().indexOf("authorize usr")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
//usr grp cmd***
//permissions cmd
else if(inputText.toLowerCase().indexOf("umask")>-1||inputText.toLowerCase().indexOf("alter default")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chmod")>-1||inputText.toLowerCase().indexOf("modify permissions")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chown :{newowner}")>-1||inputText.toLowerCase().indexOf("change owner")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chown {newowner}:{newgroup}")>-1||inputText.toLowerCase().indexOf("change owner+grp")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chown :{newgroup}")>-1||inputText.toLowerCase().indexOf("change grp")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chgrp")>-1||inputText.toLowerCase().indexOf("chg grp ownership")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("lsattr")>-1||inputText.toLowerCase().indexOf("list attributes")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("chattr")>-1||inputText.toLowerCase().indexOf("chg attributes")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("getfacl")>-1||inputText.toLowerCase().indexOf("retrieve ACL")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("setfacl")>-1||inputText.toLowerCase().indexOf("chg ACL permission")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
//permissions***
//file mgt 
else if(inputText.toLowerCase().indexOf("stat")>-1||inputText.toLowerCase().indexOf("file metadata")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("file")>-1||inputText.toLowerCase().indexOf("file info")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("ln")>-1||inputText.toLowerCase().indexOf("create links")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("cd")>-1||inputText.toLowerCase().indexOf("chg dir")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("tree")>-1||inputText.toLowerCase().indexOf("filesystem")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("mkdir")>-1||inputText.toLowerCase().indexOf("create dir")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("cp")>-1||inputText.toLowerCase().indexOf("copy file")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("mv {location}")>-1||inputText.toLowerCase().indexOf("move file")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("mv {filename}")>-1||inputText.toLowerCase().indexOf("rename file")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("rmdir")>-1||inputText.toLowerCase().indexOf("delete dir")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("rm")>-1||inputText.toLowerCase().indexOf("remove dir")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("head")>-1||inputText.toLowerCase().indexOf("file front")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("tail")>-1||inputText.toLowerCase().indexOf("file end")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("grep")>-1||inputText.toLowerCase().indexOf("search strings")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("xargs")>-1||inputText.toLowerCase().indexOf("exec each argument")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("tee")>-1||inputText.toLowerCase().indexOf("send output")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("find")>-1||inputText.toLowerCase().indexOf("search match")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("locate")>-1||inputText.toLowerCase().indexOf("search path")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("updatedb")>-1||inputText.toLowerCase().indexOf("update database")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
else if(inputText.toLowerCase().indexOf("which")>-1||inputText.toLowerCase().indexOf("complete path")>-1&&inputText.toLowerCase().indexOf("")>-1){document.getElementById("answer").innerHTML=``;}
//file mgt***
//author txt files
